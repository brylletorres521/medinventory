...
$query = "SELECT i.id, i.batch_number, i.quantity, i.purchase_price, i.selling_price, 
          i.expiry_date, i.manufacturing_date, i.purchase_date, 
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="edit_inventory.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-primary btn-action" data-toggle="tooltip" title="Edit">
